...
if __name__ == "__main__":
    ...
    image_path = os.path.join(script_directory, 'map.png')
    ...
    # Access the final coordinates after the main loop
    final_longitude, final_latitude = app.get_final_coordinates()
    print("Final Longitude Array (outside class):", final_longitude)
    print("Final Latitude Array (outside class):", final_latitude)
